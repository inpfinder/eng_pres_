...
\titlegraphic{\includegraphics[scale=2]{inpfinder-logo.png}}
...
\section{General presentation of the Site} % A subsection can be created just before a set of slides with a common theme
\begin{frame}
\frametitle{General presentation of the Site}
Site: \\
